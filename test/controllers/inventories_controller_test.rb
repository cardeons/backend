...
class InventoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post inventories_url, params: { inventory: { ingamedeck_id: @inventory.ingamedeck_id, player_id: @inventory.player_id } }
  #   end
  ...
  #   patch inventory_url(@inventory), params: { inventory: { ingamedeck_id: @inventory.ingamedeck_id, player_id: @inventory.player_id } }
