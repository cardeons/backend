...
RSpec.describe Gameboard, type: :model do
  ...
  it 'attack' do
    ...
    ingamedeck2 = Ingamedeck.create!(gameboard: gameboards(:gameboardFourPlayers), card_id: catfish2.id, cardable: players(:playerFour).monstertwo)
