...
Monstercard.create(id: 1, 
    ...
    image: 'http://localhost:3000/monster/bear.png', 
...
Monstercard.create(id: 3, 
    ...
    image: 'http://localhost:3000/monster/catfish.png', 
    action: "lose_level", 
    draw_chance: 5, 
    level: 10, 
    element: 'water', 
...
Itemcard.create(id: 4, 
    ...
    image: 'http://localhost:3000/item/helmet.png', 
    action: 'plus_one', 
    draw_chance: 13, 
    element: "fire", 
    element_modifier: 2, 
...
Itemcard.create(id: 5, 
    ...
    image: 'http://localhost:3000/item/poempel.png', 
    action: 'plus_one', 
    draw_chance: 14, 
    atk_points: 2, 
...
Itemcard.create(id: 6, 
    ...
    image: 'http://localhost:3000/item/shoes.png', 
    action: 'plus_3', 
    draw_chance: 5, 
    element: "earth", 
    element_modifier: 3, 
